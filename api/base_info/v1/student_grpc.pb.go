...
type StudentClient interface {
	...
	// 学生查询
	QueryStudent(ctx context.Context, in *QueryStudentRequest, opts ...grpc.CallOption) (*CreateStudentReply, error)
	// 学生列表查询
...
func (c *studentClient) QueryStudent(ctx context.Context, in *QueryStudentRequest, opts ...grpc.CallOption) (*CreateStudentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateStudentReply)
...
func (UnimplementedStudentServer) QueryStudent(context.Context, *QueryStudentRequest) (*CreateStudentReply, error) {
