...
func (e RuleEdges) StuLogsOrErr() ([]*StuLog, error) {
	if e.loadedTypes[0] {
...
// QueryStuLogs queries the "stuLogs" edge of the Rule entity.
func (_m *Rule) QueryStuLogs() *StuLogQuery {
	return NewRuleClient(_m.config).QueryStuLogs(_m)
}
